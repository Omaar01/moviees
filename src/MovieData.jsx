...
function MovieData() {
  const data = [
    {
      ...
      "Metascore": "83",
      "imdbRating": "7.9",
      "bandeannonce": 'www.youtube.com',
      "description": "Avatar est une franchise cinématographique américaine de science-fiction. La franchise devrait comporter à terme cinq films, le dernier étant prévu pour 2028. Le premier sort en 2009 et connaît un immense succès critique et commercial : il devient le plus gros succès de l'histoire du cinéma.",
      "Type": "movie",
      "Response": "True",
      "Images": [
  ...
  return (
    <div>
      <input value={input} onChange={handleInputChange} type="text" placeholder='search for the movie' />
      {
